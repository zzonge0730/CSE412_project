...
@.str1 = private unnamed_addr constant [17 x i8] c"./examples/2mm.c\00", align 1
@.asan_loc_descr = private unnamed_addr constant { [17 x i8]*, i32, i32 } { [17 x i8]* @.str1, i32 54, i32 24 }
...
@.asan_loc_descr4 = private unnamed_addr constant { [17 x i8]*, i32, i32 } { [17 x i8]* @.str1, i32 55, i32 52 }
@llvm.compiler.used = appending global [4 x i8*] [i8* bitcast ({ [17 x i8]*, i32, i32 }* @.asan_loc_descr to i8*), i8* getelementptr inbounds ([17 x i8]* @.str2, i32 0, i32 0), i8* bitcast ({ [17 x i8]*, i32, i32 }* @.asan_loc_descr4 to i8*), i8* getelementptr inbounds ([17 x i8]* @.str2, i32 0, i32 0)], section "llvm.metadata"
...
!0 = metadata !{[8 x i8]* getelementptr inbounds ({ [8 x i8], [56 x i8] }* @.str, i32 0, i32 0), { [17 x i8]*, i32, i32 }* @.asan_loc_descr, [17 x i8]* @.str2, i1 false, i1 false}
!1 = metadata !{[2 x i8]* getelementptr inbounds ({ [2 x i8], [62 x i8] }* @.str3, i32 0, i32 0), { [17 x i8]*, i32, i32 }* @.asan_loc_descr4, [17 x i8]* @.str2, i1 false, i1 false}
